...
:formula
  ;; File "binary_search_po6.why", line 600, characters 0-1016
  (not
  (forall (?t1 c_type)
  (forall (?tu282_368 c_unsorted)
  (forall (?nu281_369 Int)
  (forall (?vu280_370 Int)
  (forall (?allocu279_371 c_unsorted)
  (forall (?intMutu2u278_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu281_369 0)
  (valid_range
  (c_sort alloc_table ?allocu279_371) (c_sort (pointer ?t1) ?tu282_368) 0 
  (- ?nu281_369 1)))
  (forall (?k1u277_373 Int)
  (forall (?k2u276_374 Int)
  (implies
  (and (and (<= 0 ?k1u277_373) (<= ?k1u277_373 ?k2u276_374))
  (<= ?k2u276_374 (- ?nu281_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u278_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu282_368) ?k1u277_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u278_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu282_368) ?k2u276_374))))))))))
  (forall (?lu275_375 Int)
  (forall (?uu274_376 Int)
  (implies
  (and (and (<= 0 ?lu275_375) (<= ?uu274_376 (- ?nu281_369 1)))
  (forall (?ku273_377 Int)
  (implies (and (<= 0 ?ku273_377) (< ?ku273_377 ?nu281_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u278_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu282_368) ?ku273_377)))))
  ?vu280_370) (and (<= ?lu275_375 ?ku273_377) (<= ?ku273_377 ?uu274_376))))))
  (implies (<= ?lu275_375 ?uu274_376)
  (implies (not (= 2 0))
  (forall (?resultu272_378 Int)
  (implies (= ?resultu272_378 (div_int (+ ?lu275_375 ?uu274_376) 2))
  (forall (?result0u271_379 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result0u271_379)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu282_368) ?resultu272_378)))
  (implies
  (valid
  (c_sort alloc_table ?allocu279_371) (c_sort (pointer ?t1) ?result0u271_379))
  (forall (?result1u270_380 Int)
  (implies
  (= ?result1u270_380
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u278_372) (c_sort
                                                      (pointer ?t1) ?result0u271_379)))))
  (implies (< ?result1u270_380 ?vu280_370)
  (forall (?l0u269_381 Int)
  (implies (= ?l0u269_381 (+ ?resultu272_378 1))
  (forall (?ku268_382 Int)
  (implies (and (<= 0 ?ku268_382) (< ?ku268_382 ?nu281_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u278_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu282_368) ?ku268_382)))))
  ?vu280_370) (<= ?l0u269_381 ?ku268_382)))))))))))))))))))))))))))
