...
:formula
  ;; File "binary_search_po18.why", line 600, characters 0-817
  (not
  (forall (?t1 c_type)
  (forall (?tu278_368 c_unsorted)
  (forall (?nu277_369 Int)
  (forall (?vu276_370 Int)
  (forall (?allocu275_371 c_unsorted)
  (forall (?intMutu2u274_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu277_369 0)
  (valid_range
  (c_sort alloc_table ?allocu275_371) (c_sort (pointer ?t1) ?tu278_368) 0 
  (- ?nu277_369 1)))
  (forall (?k1u273_373 Int)
  (forall (?k2u272_374 Int)
  (implies
  (and (and (<= 0 ?k1u273_373) (<= ?k1u273_373 ?k2u272_374))
  (<= ?k2u272_374 (- ?nu277_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u274_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu278_368) ?k1u273_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u274_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu278_368) ?k2u272_374))))))))))
  (forall (?lu271_375 Int)
  (forall (?uu270_376 Int)
  (implies
  (and (and (<= 0 ?lu271_375) (<= ?uu270_376 (- ?nu277_369 1)))
  (forall (?ku269_377 Int)
  (implies (and (<= 0 ?ku269_377) (< ?ku269_377 ?nu277_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u274_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu278_368) ?ku269_377)))))
  ?vu276_370) (and (<= ?lu271_375 ?ku269_377) (<= ?ku269_377 ?uu270_376))))))
  (implies (> ?lu271_375 ?uu270_376)
  (or
  (and (>= (- 1) 0)
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u274_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu278_368) 
                                                         (- 1))))))
  ?vu276_370))
  (and (= (- 1) (- 1))
  (forall (?ku268_378 Int)
  (implies (and (<= 0 ?ku268_378) (< ?ku268_378 ?nu277_369))
  (not (= (s2int
          (c_sort
          c_int (acc
                (c_sort (memory c_int ?t1) ?intMutu2u274_372) (c_sort
                                                              ...
                                                              (shift
                                                              (c_sort
                                                              (pointer ?t1) ?tu278_368) ?ku268_378)))))
  ?vu276_370))))))))))))))))))
