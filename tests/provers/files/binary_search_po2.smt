...
:formula
  ;; File "binary_search_po2.why", line 600, characters 0-517
  (not
  (forall (?t1 c_type)
  (forall (?tu275_368 c_unsorted)
  (forall (?nu274_369 Int)
  (forall (?vu273_370 Int)
  (forall (?allocu272_371 c_unsorted)
  (forall (?intMutu2u271_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu274_369 0)
  (valid_range
  (c_sort alloc_table ?allocu272_371) (c_sort (pointer ?t1) ?tu275_368) 0 
  (- ?nu274_369 1)))
  (forall (?k1u270_373 Int)
  (forall (?k2u269_374 Int)
  (implies
  (and (and (<= 0 ?k1u270_373) (<= ?k1u270_373 ?k2u269_374))
  (<= ?k2u269_374 (- ?nu274_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u271_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu275_368) ?k1u270_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u271_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu275_368) ?k2u269_374))))))))))
  (forall (?ku268_375 Int)
  (implies (and (<= 0 ?ku268_375) (< ?ku268_375 ?nu274_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u271_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu275_368) ?ku268_375)))))
  ?vu273_370) (<= ?ku268_375 (- ?nu274_369 1)))))))))))))
