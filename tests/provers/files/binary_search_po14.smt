...
:formula
  ;; File "binary_search_po14.why", line 600, characters 0-1190
  (not
  (forall (?t1 c_type)
  (forall (?tu284_368 c_unsorted)
  (forall (?nu283_369 Int)
  (forall (?vu282_370 Int)
  (forall (?allocu281_371 c_unsorted)
  (forall (?intMutu2u280_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu283_369 0)
  (valid_range
  (c_sort alloc_table ?allocu281_371) (c_sort (pointer ?t1) ?tu284_368) 0 
  (- ?nu283_369 1)))
  (forall (?k1u279_373 Int)
  (forall (?k2u278_374 Int)
  (implies
  (and (and (<= 0 ?k1u279_373) (<= ?k1u279_373 ?k2u278_374))
  (<= ?k2u278_374 (- ?nu283_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu284_368) ?k1u279_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu284_368) ?k2u278_374))))))))))
  (forall (?lu277_375 Int)
  (forall (?uu276_376 Int)
  (implies
  (and (and (<= 0 ?lu277_375) (<= ?uu276_376 (- ?nu283_369 1)))
  (forall (?ku275_377 Int)
  (implies (and (<= 0 ?ku275_377) (< ?ku275_377 ?nu283_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu284_368) ?ku275_377)))))
  ?vu282_370) (and (<= ?lu277_375 ?ku275_377) (<= ?ku275_377 ?uu276_376))))))
  (implies (<= ?lu277_375 ?uu276_376)
  (implies (not (= 2 0))
  (forall (?resultu274_378 Int)
  (implies (= ?resultu274_378 (div_int (+ ?lu277_375 ?uu276_376) 2))
  (forall (?result0u273_379 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result0u273_379)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu284_368) ?resultu274_378)))
  (implies
  (valid
  (c_sort alloc_table ?allocu281_371) (c_sort (pointer ?t1) ?result0u273_379))
  (forall (?result1u272_380 Int)
  (implies
  (= ?result1u272_380
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                      (pointer ?t1) ?result0u273_379)))))
  (implies (>= ?result1u272_380 ?vu282_370)
  (forall (?result2u271_381 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result2u271_381)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu284_368) ?resultu274_378)))
  (implies
  (valid
  (c_sort alloc_table ?allocu281_371) (c_sort (pointer ?t1) ?result2u271_381))
  (forall (?result3u270_382 Int)
  (implies
  (= ?result3u270_382
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                      (pointer ?t1) ?result2u271_381)))))
  (implies (> ?result3u270_382 ?vu282_370)
  (forall (?u0u269_383 Int)
  (implies (= ?u0u269_383 (- ?resultu274_378 1))
  (forall (?ku268_384 Int)
  (implies (and (<= 0 ?ku268_384) (< ?ku268_384 ?nu283_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u280_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu284_368) ?ku268_384)))))
  ?vu282_370) (<= ?ku268_384 ?u0u269_383)))))))))))))))))))))))))))))))))
