...
:formula
  ;; File "binary_search_po1.why", line 600, characters 0-425
  (not
  (forall (?t1 c_type)
  (forall (?tu273_368 c_unsorted)
  (forall (?nu272_369 Int)
  (forall (?allocu271_370 c_unsorted)
  (forall (?intMutu2u270_371 c_unsorted)
  (implies
  (and
  (and (>= ?nu272_369 0)
  (valid_range
  (c_sort alloc_table ?allocu271_370) (c_sort (pointer ?t1) ?tu273_368) 0 
  (- ?nu272_369 1)))
  (forall (?k1u269_372 Int)
  (forall (?k2u268_373 Int)
  (implies
  (and (and (<= 0 ?k1u269_372) (<= ?k1u269_372 ?k2u268_373))
  (<= ?k2u268_373 (- ?nu272_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u270_371) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu273_368) ?k1u269_372))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u270_371) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu273_368) ?k2u268_373))))))))))
  (<= (- ?nu272_369 1) (- ?nu272_369 1)))))))))
