...
:formula
  ;; File "binary_search_po3.why", line 600, characters 0-780
  (not
  (forall (?t1 c_type)
  (forall (?tu279_368 c_unsorted)
  (forall (?nu278_369 Int)
  (forall (?vu277_370 Int)
  (forall (?allocu276_371 c_unsorted)
  (forall (?intMutu2u275_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu278_369 0)
  (valid_range
  (c_sort alloc_table ?allocu276_371) (c_sort (pointer ?t1) ?tu279_368) 0 
  (- ?nu278_369 1)))
  (forall (?k1u274_373 Int)
  (forall (?k2u273_374 Int)
  (implies
  (and (and (<= 0 ?k1u274_373) (<= ?k1u274_373 ?k2u273_374))
  (<= ?k2u273_374 (- ?nu278_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u275_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu279_368) ?k1u274_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u275_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu279_368) ?k2u273_374))))))))))
  (forall (?lu272_375 Int)
  (forall (?uu271_376 Int)
  (implies
  (and (and (<= 0 ?lu272_375) (<= ?uu271_376 (- ?nu278_369 1)))
  (forall (?ku270_377 Int)
  (implies (and (<= 0 ?ku270_377) (< ?ku270_377 ?nu278_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u275_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu279_368) ?ku270_377)))))
  ?vu277_370) (and (<= ?lu272_375 ?ku270_377) (<= ?ku270_377 ?uu271_376))))))
  (implies (<= ?lu272_375 ?uu271_376)
  (implies (not (= 2 0))
  (forall (?resultu269_378 Int)
  (implies (= ?resultu269_378 (div_int (+ ?lu272_375 ?uu271_376) 2))
  (forall (?result0u268_379 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result0u268_379)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu279_368) ?resultu269_378)))
  (valid
  (c_sort alloc_table ?allocu276_371) (c_sort (pointer ?t1) ?result0u268_379)))))))))))))))))))
