...
:formula
  ;; File "binary_search_po17.why", line 600, characters 0-1235
  (not
  (forall (?t1 c_type)
  (forall (?tu283_368 c_unsorted)
  (forall (?nu282_369 Int)
  (forall (?vu281_370 Int)
  (forall (?allocu280_371 c_unsorted)
  (forall (?intMutu2u279_372 c_unsorted)
  (implies
  (and
  (and (>= ?nu282_369 0)
  (valid_range
  (c_sort alloc_table ?allocu280_371) (c_sort (pointer ?t1) ?tu283_368) 0 
  (- ?nu282_369 1)))
  (forall (?k1u278_373 Int)
  (forall (?k2u277_374 Int)
  (implies
  (and (and (<= 0 ?k1u278_373) (<= ?k1u278_373 ?k2u277_374))
  (<= ?k2u277_374 (- ?nu282_369 1)))
  (<= (s2int
      (c_sort
      c_int (acc
            (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                          (pointer ?t1) 
                                                          (shift
                                                          (c_sort
                                                          (pointer ?t1) ?tu283_368) ?k1u278_373))))) 
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                      (pointer ?t1) (shift
                                                                    (c_sort
                                                                    (pointer
                                                                    ?t1) ?tu283_368) ?k2u277_374))))))))))
  (forall (?lu276_375 Int)
  (forall (?uu275_376 Int)
  (implies
  (and (and (<= 0 ?lu276_375) (<= ?uu275_376 (- ?nu282_369 1)))
  (forall (?ku274_377 Int)
  (implies (and (<= 0 ?ku274_377) (< ?ku274_377 ?nu282_369))
  (implies
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu283_368) ?ku274_377)))))
  ?vu281_370) (and (<= ?lu276_375 ?ku274_377) (<= ?ku274_377 ?uu275_376))))))
  (implies (<= ?lu276_375 ?uu275_376)
  (implies (not (= 2 0))
  (forall (?resultu273_378 Int)
  (implies (= ?resultu273_378 (div_int (+ ?lu276_375 ?uu275_376) 2))
  (forall (?result0u272_379 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result0u272_379)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu283_368) ?resultu273_378)))
  (implies
  (valid
  (c_sort alloc_table ?allocu280_371) (c_sort (pointer ?t1) ?result0u272_379))
  (forall (?result1u271_380 Int)
  (implies
  (= ?result1u271_380
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                      (pointer ?t1) ?result0u272_379)))))
  (implies (>= ?result1u271_380 ?vu281_370)
  (forall (?result2u270_381 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result2u270_381)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu283_368) ?resultu273_378)))
  (implies
  (valid
  (c_sort alloc_table ?allocu280_371) (c_sort (pointer ?t1) ?result2u270_381))
  (forall (?result3u269_382 Int)
  (implies
  (= ?result3u269_382
  (s2int
  (c_sort
  c_int (acc
        (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                      (pointer ?t1) ?result2u270_381)))))
  (implies (<= ?result3u269_382 ?vu281_370)
  (or
  (and (>= ?resultu273_378 0)
  (= (s2int
     (c_sort
     c_int (acc
           (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                         ...
                                                         (shift
                                                         (c_sort
                                                         (pointer ?t1) ?tu283_368) ?resultu273_378)))))
  ?vu281_370))
  (and (= ?resultu273_378 (- 1))
  (forall (?ku268_383 Int)
  (implies (and (<= 0 ?ku268_383) (< ?ku268_383 ?nu282_369))
  (not (= (s2int
          (c_sort
          c_int (acc
                (c_sort (memory c_int ?t1) ?intMutu2u279_372) (c_sort
                                                              ...
                                                              (shift
                                                              (c_sort
                                                              (pointer ?t1) ?tu283_368) ?ku268_383)))))
  ?vu281_370)))))))))))))))))))))))))))))))))
