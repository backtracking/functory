...
:formula
  ;; File "binary_search_po16.why", line 600, characters 0-1135
  (not
  (forall (?t1 c_type)
  ...
  (forall (?u0u268_383 Int)
  (implies (= ?u0u268_383 (- ?resultu273_378 1))
  (< (- ?u0u268_383 ?lu276_375) (- ?uu275_376 ?lu276_375)))))))))))))))))))))))))))))))
