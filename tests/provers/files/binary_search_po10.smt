...
:formula
  ;; File "binary_search_po10.why", line 600, characters 0-954
  (not
  (forall (?t1 c_type)
  ...
  (forall (?result2u268_381 c_unsorted)
  (implies
  (= (c_sort (pointer ?t1) ?result2u268_381)
  (c_sort
  (pointer ?t1) (shift (c_sort (pointer ?t1) ?tu281_368) ?resultu271_378)))
  (valid
  (c_sort alloc_table ?allocu278_371) (c_sort (pointer ?t1) ?result2u268_381)))))))))))))))))))))))))
