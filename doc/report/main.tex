...
% TODO: explain the issue with closures referring to global variables here
...
\of{Network.Same} (as explained below in Section~\ref{sec:implem}). 
...
transmitted from the master can not refer to global variables in the
...
% TODO : explain the new derived API
