...
\of{Functory} from other work with related goals and motivations, we can
...
could still be used with \of{Functory}. Basically, the task will be
transmitted along with the corresponding type and on unmarshalling, it
could be matched for the correct type.
...
are programming languages themselves, our library, \of{Functory},
could be implemented using any of the above. The main goal of
\of{Functory} is to provide the users of an existing functional
programming language high-level user-friendly APIs that hides the
messy details of task distribution and fault-tolerance, enabling a
ready-to-use library for efficient utilization of computing resources.
