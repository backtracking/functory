...
Google's MapReduce in Erlang~\cite{erlang}. Another MapReduce
implementation in \Ocaml\ is Yohann Padioleau's MapReduce
...
protocol for message passing. Our library is not an impementation of
Google's MapReduce. Currently, we have less flexibility
