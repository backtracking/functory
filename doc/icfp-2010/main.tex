...
and recovers the result from the local file. Then function \of{handle}
...
task $t$ is rescheduled, which means 

\subsubsection{Same, Poly and Mono} % TODO: change title
...
% LocalWords:  parallelize functor parameterized indices endianness
