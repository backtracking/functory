...
\begin{itemize}
\item A notion of a \of{task} which denotes the computation to be
  performed in a distributed manner
\item A set of machines or programs called \of{workers} that perform
  the tasks, producing results
\item A machine or a program called a \of{master} that is incharge
